...
$percentage = 0;
unset($query1);
$query1 = "INSERT INTO project_details VALUES(NULL, 0,'$project_name', '$project_description', '$percentage', NOW(), '$project_domain','$start_date', '$end_date')";

if($mysqli->query($query1)or die($query."<br>".$mysqli->error)){
  $msg = "Project Created";
                    ...
                    <strong class="font-bold text-lt"><?php echo $_SESSION['username']?></strong> <b class="caret"></b> </span>
                       ...
                       <ul class="dropdown-menu animated fadeInRight m-t-xs"> 
                        <li class="divider"></li> 
                          ...
                          <li class="active"><a href="add_students.php" class="auto"> <i class="i i-statistics icon"> </i> <span class="font-bold">Create Group</span> </a> 
                          </li>
                          </ul> 
