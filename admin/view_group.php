...
$query3 = "SELECT u.firstname, u.lastname, p.group_id g FROM group_allot g INNER JOIN users u on g.guide_id = u.id inner join project_group p on p.user_id = g.leader_id";
                               ...
                               <div class="table-responsive"> 
                                 <table class="table table-striped b-t b-light">
                                   ...
                                   <?php while($data = $result3->fetch_assoc()){?>
                                    ...
                                    <tr>
                                      <td><?php echo $data[
                                      'firstname']." ".$data['lastname']?></td>
                                      <td><?php echo $data['g']?></td>
                                      <td><a href="view_group_details.php?gid=<?php echo $data['g']?>" class="btn btn-warning btn-sm">View</a></td>
                                    </tr>
                                   <?php }?>
                                 </table>
                                 </div>
