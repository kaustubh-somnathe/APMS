...
// $query1 = "SELECT  * FROM project_group WHERE is_leader=1";
// $groupquery = $mysqli->query($query1) or die($query1."<br>".$mysqli->error);

// $i=0;
// $groupinfo=array();
// while ($groupData= $groupquery->fetch_assoc()) {
// $user_id = $groupData['user_id'];
//   $query2 = "SELECT * FROM project_uploads WHERE student_id = '$user_id' AND is_approved=1";
//   $groupquery = $mysqli->query($query2) or die($query2."<br>".$mysqli->error);
//   $Numberofrows = $groupquery->num_rows;
//   $groupinfo[$i]['count'] = $Numberofrows;
                            ...
                            <a href="#nav" data-toggle="class:nav-xs" class="btn btn-icon icon-muted btn-inactive m-l-xs m-r-xs"> <i class="i i-circleleft text"></i> <i class="i i-circleright text-active"></i> </a> </footer>
                             ...
                             <section class="row m-b-md">
                                ...
                                <section class="panel panel-default"> 
                                  <header class="panel-heading font-bold">Leaders</header> 
