...
<head>
<meta charset="utf-8" /> 
<title>ASP | Project Management</title>
             ...
             <ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user user">
                  ...
                  <section class="vbox">
                   ...
                   <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="10px" data-railOpacity="0.2"> <div class="clearfix wrapper dk nav-user hidden-xs"> 
                    </div> <!-- nav --> <!-- nav --> <nav class="nav-primary hidden-xs"> 
                          <div class="text-muted text-sm hidden-nav-xs padder m-t-sm m-b-sm">Start</div> 
                          <ul class="nav nav-main" data-ride="collapse"> 
                          <li class="active"><a href="login.php" class="auto"> <i class="i i-statistics icon"> </i> <span class="font-bold">Login</span> </a> 
                          </li>
                          <li><a href="register.php" class="auto"> <i class="i i-statistics icon"> </i> <span class="font-bold">Register</span> </a> 
                          </li>
                          </ul 
                            ...
                            <a href="#nav" data-toggle="class:nav-xs" class="btn btn-icon icon-muted btn-inactive m-l-xs m-r-xs"> <i class="i i-circleleft text"></i> <i class="i i-circleright text-active"></i> </a> </footer>
                             ...
                             <div class="row">
                              <div class="col-md-5 col-md-offset-4">
                               ...
                               <label for="two">2013-14</label>
                                <input type="radio" id="two" name="project">
                               <label for="three">2013-14</label>
