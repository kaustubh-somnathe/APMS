...
$query = "SELECT project_group.group_id, project_group.user_id,group_allot.project_id, project_details.* FROM project_group inner join group_allot on project_group.user_id = group_allot.leader_id inner join project_details on group_allot.project_id=project_details.id where group_allot.guide_id = '$user_id'";
                             ...
                             <div class="row">
                               <div class="col-sm-12"> 
                                <section class="panel panel-default"> 
                                  <header class="panel-heading font-bold">Project Details</header> 
                                <div class="panel-body"> 
                                 <table class="table table-striped b-t b-light">
                                   ...
                                   <tr>
                                     <td><?php echo $i;?></td>
                                     <td><?php echo $ProjData['group_id'];?></td>
                                     <td><?php echo $ProjData['project_name'];?></td>
                                     <td><?php echo $ProjData['project_description'];?></td>
                                     <td><?php echo $ProjData['project_domain'];?></td>
                                     <td><?php echo $ProjData['created'];?></td>
                                     <td><?php echo $ProjData['start_date'];?></td>
                                     <td><?php echo $ProjData['end_date'];?></td>
                                     <td>
                                     <p><a href="view_project_details.php?pid=<?php echo $ProjData['project_id'];?>" class="btn btn-warning btn-sm">View Project</a></p>
                                     <p><a href="view_group.php?gid=<?php echo $ProjData['group_id'];?>" class="btn btn-warning btn-sm">View Group</a></p>
