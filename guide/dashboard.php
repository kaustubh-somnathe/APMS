...
$query1 = "SELECT * FROM notifications WHERE receiver_id = '$user_id' ORDER BY created DESC";
$notificationResult = $mysqli->query($query1) or die($query1."<br>".$mysqli->error);
                       ...
                       <ul class="dropdown-menu animated fadeInRight m-t-xs"> 
                        <li class="divider"></li> 
                          ...
                          <li><a href="reference.php" class="auto"> <i class="i i-statistics icon"> </i> <span class="font-bold">Reference</span> </a> 
                            ...
                            <header class="panel-heading"><b>Notifications</b> 
                            </header> 
                            <?php date_default_timezone_set('Asia/Kolkata');?>
                            <section class="panel-body slim-scroll" data-height="230px" data-size="10px"> <div class="line pull-in"></div> 
                              <?php while ($notificationData = $notificationResult->fetch_assoc()) {?>
                              <article class="media"> 
                              <span class="pull-left thumb-sm"><i class="fa fa-file-o fa-3x icon-muted"></i></span>
                              <div class="media-body"> 
                              <div class="pull-right media-xs text-center text-muted"> <strong class="h4"><?php echo date("d", strtotime($notificationData['created']))?></strong><br> <small class="label bg-light"><?php echo date("M", strtotime($notificationData['created']))?></small> </div>
                              <a href="#" class="h4"><?php echo $notificationData['message']?></a><small class="block m-t-sm"></small>
                              </div> 
                              </article>
                              <?php } ?>
                             </section> 
